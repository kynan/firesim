...
# See "Menu Tools/Options/Projects/VC++ Directories" in VS 7.1/8.0
#
# OPTIONS
# NO_TARGET_DOC : Set to 1 to suppress "doc" target, useful if you just want doxygen config
#                 Otherwise a "make doc" target is added that does not belong to ALL
#
# author Jan Woetzel 2004-2007
...
IF (DOXYGEN_FOUND)
  ...
  # click+jump in Emacs and Visual Studio (for doxy.config) need different format:
  ...
  # the target (make doc) can be suppressed
  # useful if you just want to use it to configure doxygen config
  IF   (NOT  NO_TARGET_DOC)
    # target that is always out of date but does NOT belong to ALL
    # thus won't be built onmake all.
  ...
  IF    (WIN32)
    ...
    IF   (HTML_HELP_COMPILER)
      ...
      ADD_CUSTOM_TARGET(winhelp COMMAND ${HTML_HELP_COMPILER} ${HHP_FILE})
      #ADD_DEPENDENCIES (winhelp doc) # do NOT add this dependency because of ALL sideeffect on doc target
